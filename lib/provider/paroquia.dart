...
class ParoquiaProvider with ChangeNotifier {
  ...
  static Map<String, Map<String, String>> missasMap = {
    ...
    "Quinta-feira": {"19h30": "Matriz de São Sebastião"},
    "1a Sexta-feira": {
    ...
    "Sábado": {
      "17h00": "Capela São Benedito",
      "19h00": "Capela São Francisco de Assis",
    },
    "Domingo": {
      "07h30": "Capela Nossa Senhora Aparecida",
      "09h30": "Matriz de São Sebastião",
  ...
  static Map<String, Map<String, String>> confissoesMap = {
    "Terça-feira": {"15h00 - 17h00": "Paróquia São Sebastião"},
    "Quinta-feira": {"15h00 - 17h00": "Paróquia São Sebastião"},
    "Sábado": {"09h00 - 11h00": "Paróquia São Sebastião"},
  };
  ...
  static List<Map<String, dynamic>> igrejasMap = [
    ...
    {
      "nome": "São Benedito",
      "endereco": "Av. Antônio Pedro Tomitão, 633",
      "bairro": "São Benedito",
      "cidade": "Novo Horizonte",
      "estado": "SP",
      "cep": "14965-280",
    ...
    {
      "nome": "São Francisco",
      "endereco": "Rua Ubaldino Antunes de Oliveira, 635",
    ...
    },
    {
      ...
      "endereco": "Rua Salomão Jacob, 604",
    ...
    },
    {
      ...
      "endereco": "Rua Antenor Mestriner, 180",
    ...
    },
    {
      ...
      "endereco": "Avenida da Saudade, 1069",
      "bairro": "Vila Cardoso",
      "cidade": "Novo Horizonte",
      "estado": "SP",
      "cep": "14960-000",
    ...
    },
    {
      ...
      "missas": {"4a Sexta-feira": "19h30"},
        ...
        {
      "nome": "N.S. Aparecida (Dois Córregos)",
      "endereco": "Bairro Dois Córregos",
      "bairro": "Área Rural",
      "cidade": "Novo Horizonte",
      "estado": "SP",
      "cep": "14960-000",
    ...
    {
      "nome": "Santa Rita e Santa Luzia",
      "endereco": "Sítio Santa Luzia (Área Rural)",
      "bairro": "Pau d'Alho",
      "cidade": "Novo Horizonte",
      "estado": "SP",
      "cep": "14960-000",
